...
Original file is located at
    https://colab.research.google.com/drive/1CuN4g2W1QgTsCT3XvJPh_-g_kr0ZcSQ7
"""
...
st.sidebar.markdown("""
[Sample CSV input file](https://raw.githubusercontent.com/dataprofessor/data/master/penguins_example.csv)
""")
...
if uploaded_file is not None:
    ...
    def user_input_features():
        #track_id = st.sidebar.slider('track_id',1,10000,100)
        ...
        data = {'premium': premium,
                ...
                'hist_user_behavior_n_seekfwd':hist_user_behavior_n_seekfwd,#hist_user_behaviour_n_seekfwd	
...
pred_skip_1 = np.argmax(model.predict_proba(input_df[features]),axis=1)#model.predict(input_df[features])
pred_skip_2 = np.argmax(model2.predict_proba(input_df[features]),axis=1)#model2.predict(input_df[features])
pred_skip_3 = np.argmax(model3.predict_proba(input_df[features]),axis=1)#model3.predict(input_df[features])
